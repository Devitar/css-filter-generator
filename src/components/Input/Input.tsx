...
type Props = TextProps | ToggleProps
...
/** Component */
/** Renders an input element, either as a text input or checkbox/radio. */
    ...
    return (
      <div className="input-container text-input-container">
        <input
          ...
          value={value}
        />
        {label && <label className="input-label text-input-label" htmlFor={id}>{label}</label>}
      </div>
    )
  }
